...
const Hero = () => {
  return (
    ...
    bg-no-repeat bg-cover bg-center h-screen'>
      ...
      <h1 className='font-playfair text-2xl md:text-5xl md:text-[56px] md:leading-[56px] font-bold md:font-extrabold max-w-xl mt-4'>Chase elegance. Reserve your
        dream stay now.</h1>
      <p className='max-w-130 mt-4 text-sm md:text-base ' >Discover the finest hotels from all over the world</p>
