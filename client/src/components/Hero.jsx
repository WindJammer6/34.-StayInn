...
const Hero = ({
  ...
  useEffect(() => {
    worker.current = new Worker(
      new URL("../workers/autocompleteworker.js", import.meta.url),
      {
        type: "module",
      }
    );
  ...
  const handleSubmit = (e) => {
    ...
    const matchedDestination = destinations.find(
      (d) =>
        typeof d.term === "string" &&
        d.term.toLowerCase().trim() === trimmedInput
    );
  ...
  const guestRoomError = (() => {
    ...
    if (totalGuests > maxTotalGuests)
      return `Total guests cannot exceed ${maxTotalGuests}.`;
    return "";
  })();
        ...
        <div className="flex flex-col gap-2">
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              onClick={() => handleRoomChange(1)}
              disabled={
                rooms >= maxRooms || rooms * guestsPerRoom >= maxTotalGuests
              }
              className="w-7 h-7 rounded bg-gray-200 text-lg font-bold flex items-center justify-center"
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              disabled={
                guestsPerRoom >= maxGuestsPerRoom ||
                rooms * (guestsPerRoom + 1) > maxTotalGuests
              }
              className="w-7 h-7 rounded bg-gray-200 text-lg font-bold flex items-center justify-center"
